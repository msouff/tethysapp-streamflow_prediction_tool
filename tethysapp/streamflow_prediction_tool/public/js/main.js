...
//FUNCTION: Table of Contents (treeview)
$(function () {
    ...
    $('.tree li.parent_li > span').on('click', function (e) {
        ...
        if (children.is(":visible")) {
            children.hide('fast');
            $(this).attr('title', 'Expand this branch').find(' > i').addClass('glyphicon-chevron-right').
            removeClass('glyphicon-chevron-down');
        } else {
            children.show('fast');
            $(this).attr('title', 'Collapse this branch').find(' > i').addClass('glyphicon-chevron-down').
